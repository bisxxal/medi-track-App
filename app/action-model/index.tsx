  ...
  return (
    <View className=' flex h-screen items-center justify-center'>
      ...
      <View className=' mt-10'>
        ...
        <View className='flex flex-row items-center gap-4 justify-center mt-10 border rounded-2xl'>
          <View>
            <Image  className='w-24 rounded-xl h-24' source={{uri: medicine?.type?.icon}} />
          </View> 
          <View>
        ...
        <View className='flex flex-row gap-3 items-center justify-center mt-10'>
          <TouchableOpacity onPress={()=>updateMedicine('Taken')} className=' flex flex-row items-center gap-2 bg-green-400 px-6 rounded-3xl py-2'>
          <Feather name="check" size={24} color="#166534" />
             <Text className=' text-green-800'>Taken</Text></TouchableOpacity> 
          <TouchableOpacity onPress={()=>updateMedicine('Missed')} className=' flex flex-row items-center gap-2 bg-red-500 px-6 rounded-3xl py-2'> <Entypo name="cross" size={24} color="#7f1d1d" /> <Text className=' text-red-900'>Missed</Text></TouchableOpacity> 
          </View>
            </View>
